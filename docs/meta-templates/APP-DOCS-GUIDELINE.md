...
## 3. The 10-Day Delivery Bootstrapping

Rule Before a single line of application code is written, the developer MUST read `projects/arena-core/docs/api-reference.md` to map the application's target product requirements against the Core's existing capabilities.
### 3.1. Architectural Feature Decision Flow
